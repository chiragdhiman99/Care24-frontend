...
import { Smartphone, CreditCard, Building2, ShieldCheck } from "lucide-react";
...
const PaymentSection = ({}) => {
  ...
  if (paying) {
    return (
      <div className="min-h-screen bg-[#f0f7f5] flex flex-col items-center justify-center gap-4">
        <div className="w-14 h-14 border-4 border-[#2baf8e] border-t-transparent rounded-full animate-spin"></div>
          ...
          <div className="space-y-4 -mt-2 sm:-mt-11">
            ...
            >
              {paying ? (
                ...
                `Pay ₹${bookingdata.amount ? Number(bookingdata.amount).toFixed(2) : "0.00"}`
              )}
            </button>
